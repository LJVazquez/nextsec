<div class="container border bg-light py-2">
    <div class="row">
        <div class="col-12 d-flex align-items-center">
            <h4>Emails</h4>
            <a href="emails/create" class="btn btn-success btn-sm mx-2">+ Agregar</a>
        </div>
            ...
            <table class="table table-bordered bg-white mt-2">
                ...
                <tbody>
                    ...
                    @foreach ($emails as $email)
                        <tr>
                            <td>{{ $email->id }}</td>
                            <td><a href="/emails/{{ $email->id }}" class="text-decoration-none">
                                    {{ $email->name }}
                                </a></td>
                            ...
                            <td class="d-flex">
                                <a href="/emails/{{ $email->id }}/edit" class="btn btn-secondary me-2">Editar</a>
